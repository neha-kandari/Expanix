      ...
      <nav className="container mx-auto flex items-center justify-between py-4 px-4 sm:px-10">
        ...
        <div className="flex items-center gap-2">
          <div className="bg-white rounded w-8 h-8 flex items-center justify-center">
            <span className="text-black text-lg font-bold font-mono">A</span>
          </div>
          <span className="text-lg font-bold text-white font-mono tracking-widest">WebAgency</span>
        </div>
          ...
          <div className="relative mt-8 w-[95vw] max-w-md rounded-2xl bg-black shadow-2xl flex flex-col items-stretch p-0">
            ...
            <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-white/10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-base font-bold text-white font-mono tracking-widest">WebAgency</span>
              </div>
              <div className="flex items-center gap-2">
                <button className="text-white p-2 rounded hover:bg-white/10 transition" aria-label="Toggle theme">
                  <Moon size={20} />
                </button>
                <button
            ...
            <div className="flex flex-col gap-2 px-6 py-6">
              ...
              <div className="py-2" />
              <div className="text-center font-bold text-white text-base mb-2 mt-2">AI Chat &amp; Voice</div>
